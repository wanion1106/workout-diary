        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="d-flex flex-wrap justify-content-center justify-content-around">
                    <div class="card mb-5" style="width: 18rem; background-color: #2F4F4F;">
                        <img class="card-img-top" src="/images/workoutRecord.png" width="100%" height="180">
                    ...
                    <div class="card mb-5" style="width: 18rem; background-color: #2F4F4F;">
                        <img class="card-img-top" src="/images/selfy.png" width="100%" height="180">
                        <div class="card-body" style="color: white;">
                ...
                <div class="d-flex flex-wrap justify-content-center justify-content-around">
                    <div class="card mb-5" style="width: 18rem; background-color: #2F4F4F;">
                        <img class="card-img-top" src="/images/pen.png" width="100%" height="180">
                        <div class="card-body" style="color: white;">
                    ...
                    <div class="card mb-5" style="width: 18rem; background-color: #2F4F4F;">
                        <img class="card-img-top" src="/images/note.png" width="100%" height="180">
                        <div class="card-body" style="color: white;">
